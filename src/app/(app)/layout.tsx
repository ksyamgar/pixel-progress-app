    ...
    <SidebarProvider defaultOpen>
      <Sidebar variant="sidebar" collapsible="icon" className="border-r-border/30">
        <SidebarHeader className="p-4 items-center justify-center flex flex-col">
           <Image src="https://placehold.co/100x100.png" alt="Pixel Progress Logo" data-ai-hint="pixel game logo" width={70} height={70} className="rounded-full border-2 border-primary mb-2 group-data-[collapsible=icon]:hidden" />
           <div className="font-pixel text-lg font-bold text-primary group-data-[collapsible=icon]:hidden">Pixel User</div>
        </SidebarHeader>
